namespace VKLib.Enums.SafetyEnums
{
	...
	public sealed class UserSection : SafetyEnum<UserSection>
	{
		...
		/// Искать среди друзей.
		/// </summary>
		public static readonly UserSection Friends = RegisterPossibleValue("friends");

		/// <summary>
		/// Искать среди друзей и подписок пользователя список строк, разделенных через запятую.
		/// </summary>
		public static readonly UserSection Subscriptions = RegisterPossibleValue("subscriptions");
	}
}