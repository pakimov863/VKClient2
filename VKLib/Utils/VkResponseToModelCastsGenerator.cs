// Autogenerated at 30.03.2016 17:01:38
...
namespace VKLib.Utils
{
    public partial class VkResponse
    {
		...
		{
            return response == null || response._token == null || !response._token.HasValues ? null :  AccountChangePasswordResult.FromJson(response);
        }
		...
		{
            return response == null || response._token == null || !response._token.HasValues ? null :  CategoryGroup.FromJson(response);
        }
		...
		{
            return response == null || response._token == null || !response._token.HasValues ? null :  ChatPushSettings.FromJson(response);
        }
		...
		{
            return response == null || response._token == null || !response._token.HasValues ? null :  GroupsCatalogInfo.FromJson(response);
        }
		...
		{
            return response == null || response._token == null || !response._token.HasValues ? null :  GroupsEditParams.FromJson(response);
        }
		...
		{
            return response == null || response._token == null || !response._token.HasValues ? null :  MessagesPushSettings.FromJson(response);
        }
